...
Yay, it works! But if we try to just print out <span
...
Of course, since <span class="fixed">Person</span> is now in <span
...
Because <span class="fixed">==</span> was defined in terms of <span
